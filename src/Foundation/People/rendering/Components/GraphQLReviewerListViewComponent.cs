...
{
    public class GraphQLReviewerListViewComponent : ViewComponent
    {
        private readonly IGraphQLPeopleService _graphQLPeopleService;

        public GraphQLReviewerListViewComponent(IGraphQLPeopleService graphQLProductsService)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            searchParams.RootItemId = "{28C8D691-4AC6-418F-A2A3-697F57385726}";
            ...
            var results = await _graphQLPeopleService.Search(searchParams, false);
            return View(results);
        }
